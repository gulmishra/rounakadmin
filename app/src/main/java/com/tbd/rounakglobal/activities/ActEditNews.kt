...
class ActEditNews : AppCompatActivity() {
...
//                    val mp = MediaPlayer.create(this, Uri.parse(outputFilePath))
                    ...
                    if ((duration / 1000) > 30) {
                            Toast.makeText(this@ActEditNews,"Video greater then 30 sec not allowed",Toast.LENGTH_SHORT).show()
                        } else {
                            try {
                                val outputFilePath = filePath.substring(0,filePath.lastIndexOf("/"))+"compressed_video.mp4"

                                compressVideo(selectedVieo, outputFilePath,this@ActEditNews)
                        ...
                        if (response.body()!!.success.equals("1")) {
                            ...
                            kotlin.run {
                                ...
                                val meterSrNumAdapter: ArrayAdapter<*> =
                                    ArrayAdapter<String>(this@ActEditNews, R.layout.search_layout, CatSearchList!!)
                    ...
                    if (response.isSuccessful) {
                        if (response.body()!!.success.equals("1")) {
                            ...
                            kotlin.run {
                                ...
                                val meterSrNumAdapter: ArrayAdapter<*> =
                                    ArrayAdapter<String>(this@ActEditNews, R.layout.search_layout, SubCatSearchList!!)
