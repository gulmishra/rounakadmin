...
class ActAddSubCat : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val meterSrNumAdapter: ArrayAdapter<*> =
            ArrayAdapter<String>(this@ActAddSubCat, R.layout.search_layout, countrySearchList!!)
                    ...
                    if (response.isSuccessful) {
                        if (response.body()!!.success.equals("1")) {
                            ...
                            kotlin.run {
                                ...
                                val meterSrNumAdapter: ArrayAdapter<*> =
                                    ArrayAdapter<String>(this@ActAddSubCat, R.layout.search_layout, CatSearchList!!)
